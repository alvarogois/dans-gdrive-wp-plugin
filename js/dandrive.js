function print_file_row(data,i,api_key) {
	...
	switch(mimeType) {
		...
		case 'application/pdf':
			var fileType = 'PDF';
			var dlLink = '<a href="https://drive.google.com/uc?export=download&id='+id+'" target="_blank"><button style=\"width:100%\">'+script_strings.download+'</button></a>';
		...
		case 'application/vnd.google-apps.document':
			...
			var dlLink = '<a href="https://docs.google.com/document/d/'+id+'/export?format=doc" target="_blank"><button style=\"width:100%\">'+script_strings.export+'</button></a>';
		...
		case 'application/vnd.google-apps.presentation':
			...
			var dlLink = '<a href="https://docs.google.com/presentation/d/'+id+'/export/pptx" target="_blank"><button style=\"width:100%\">'+script_strings.export+'</button></a>';
		...
		case 'application/vnd.google-apps.spreadsheet':
			...
			var dlLink = '<a href="https://docs.google.com/spreadsheets/d/'+id+'/export?format=xlsx" target="_blank"><button style=\"width:100%\">'+script_strings.export+'</button></a>';
	...
	if(viewLink == '') {
		...
		viewLink = '<a href="https://drive.google.com/file/d/'+id+'/view" target="_blank">'+fName+' ('+script_strings.view+')</a>';
